	...
	<view class="container">
		<view class="page-body">
			<view class='wrapper'>
				...
				<view class='toolbar' @tap="format" style="height: 120rpx;overflow-y: auto;margin-top: 100rpx;">
					...
					<view :class="formats.marginTop ? 'ql-active' : ''" class="iconfont icon-722bianjiqi_duanqianju"
						data-name="marginTop" data-value="20rpx"></view>
					<view :class="formats.previewarginBottom ? 'ql-active' : ''"
						class="iconfont icon-723bianjiqi_duanhouju" data-name="marginBottom" data-value="20rpx"></view>
					<view class="iconfont icon-clearedformat" @tap="removeFormat"></view>
					<view :class="formats.fontFamily ? 'ql-active' : ''" class="iconfont icon-font"
						data-name="fontFamily" data-value="Pacifico"></view>
					<view :class="formats.fontSize === '24rpx' ? 'ql-active' : ''" class="iconfont icon-fontsize"
						data-name="fontSize" data-value="24rpx"></view>
...
<style>
	...
	.page-body {
		height: calc(430rpx - var(--window-top) - var(--status-bar-height));
	}
	...
	.editor-wrapper {
		height: calc(360rpx - var(--window-top) - var(--status-bar-height) - 140rpx);
		background: #fff;
	}
